...
public class Add_and_Remove {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-----------------------------------------------------------------------------------------------------------------------------\n");
        listadodeestecurso.remove(estudiante8); 
        listadodeestecurso.remove(estudiante1);        
        System.out.println("Tras remover al primer y [ultimo estudiante, las personas registradas en el listado  de curso, con su respectiva edad son: ");
        while(iteradora.hasNext()) {
        System.out.println(iteradora.next().toString()); 
